...
public class MongoDBRepository {
    ...
    public CompletionStage<Optional<Hero>> heroById(String heroId) {
        ...
        CompletableFuture<Document> val = ReactiveStreamsUtils.fromSinglePublisher(heroesCollection.find(document).first());
        return val.thenApply(result -> Optional.ofNullable(result).map(Document::toJson).map(Hero::fromJson));
    }
